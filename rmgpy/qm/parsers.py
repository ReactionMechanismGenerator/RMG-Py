...
class CCLibParser:
    ...
    def parse(self, molecule):
        try:
            ...
            """
            energy = 0#PM3 energy (Hf298) in Hartree 
            (***note: in the case of MOPAC, the MOPAC file will contain in units 
                      of kcal/mol, but modified ccLib will return in Hartree)
            ...
            self.qmdata = CCLibData(cclib_data, groundStateDegeneracy=(radicalNumber + 1))

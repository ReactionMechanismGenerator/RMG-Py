...
7    [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {2,S}
8    [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {2,S}
9    [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {3,S}
10   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {3,S}
...
13   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {4,S}
14   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {4,S}
15   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {5,S}
16   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {5,S}
17   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {5,S}
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=([0, 0, 0, 0, 0, 0, 0], "cal/(mol*K)"),
...
5   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {2,S}
6   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {2,S}
7   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {3,S}
8   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {3,S}
9   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {3,S}
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
...
5    Css                         u0 {3,S}
6    [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {3,S}
7    [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {3,S}
8    [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {4,S}
9    [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {4,S}
10   [Cdb,Cdd,Ct,Cb,Cbf,O2s,CO,H] u0 {4,S}
""",
    thermo=ThermoData(
        Tdata=([300, 400, 500, 600, 800, 1000, 1500], "K"),
        Cpdata=([0, 0, 0, 0, 0, 0, 0], "cal/(mol*K)"),

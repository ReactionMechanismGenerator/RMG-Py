...
class TestFragment:
    def setup_class(self):
        ...
        for vertex in vertices:
            self.fragment1.add_vertex(vertex)
        for bond in bonds:
        ...
        for vertex in vertices:
            self.fragment2.add_vertex(vertex)
        for bond in bonds:
    ...
    def test_from_smiles_like_string1(self):
        ...
        for vertex in vertices:
            expected_fragment.add_vertex(vertex)
        for bond in bonds:
    ...
    def test_from_SMILES_like_string2(self):
        ...
        vertices = [atom_C, cutting_label_R1, cutting_label_R2, atom_H1, atom_H2]
    ...
    def test_from_SMILES_like_string3(self):
        ...
        vertices = [atom_C, cutting_label_R, cutting_label_L, atom_H1, atom_H2]
    ...
    def test_update_atomtypes(self):
        ...
        for vertex in vertices:
            fragment.add_vertex(vertex)
        for bond in bonds:
            fragment.add_edge(bond)

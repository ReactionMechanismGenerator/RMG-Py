...
conformer(
    ...
    modes = [
        ...
        HinderedRotor(
            inertia = (7.33475, 'amu*angstrom^2'),
            symmetry = 6,
            barrier = (0.053308, 'kJ/mol'),
            quantum = None,
            semiclassical = None,
        ),
    ],
...
#            400      33.462      14.831      87.888     -20.324
...
thermo(
    ...
    thermo = NASA(
        polynomials = [
            NASAPolynomial(
                coeffs = [3.98797, -0.000174216, 0.000171975, -2.90601e-07, 1.5636e-10, 3752.67, 11.8436],
                Tmin = (10, 'K'),
                Tmax = (560.873, 'K'),
            ),
            NASAPolynomial(
                coeffs = [-2.50586, 0.0623788, -3.87516e-05, 1.14997e-08, -1.30886e-12, 4225.66, 37.1402],
                Tmin = (560.873, 'K'),
                Tmax = (3000, 'K'),
            ),
        ],

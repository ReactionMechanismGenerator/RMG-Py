...
energy = {
    'CBS-QB3': QchemLog('iC5H11O-2_betasc_CH2CHOHm08.out'),    
}
...
rotors = [
    HinderedRotor(scanLog=QchemLog('c5h11o2scan4.out'), pivots=[2,3], top=[3,8,9,10], symmetry=3, fit='best'), #ch3, using c5h11o2scan4.out
    HinderedRotor(scanLog=QchemLog('c5h11o2scan4.out'), pivots=[1,2], top=[1,5,6,7], symmetry=3, fit='best'), #ch3
    HinderedRotor(scanLog=QchemLog('c5h11o2scan5.out'), pivots=[12,13], top=[13,17], symmetry=1, fit='best'), # oh
]

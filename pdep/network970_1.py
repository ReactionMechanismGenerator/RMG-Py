...
"""),
    E0 = (-7.60246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.00534486,'amu*angstrom^2'), symmetry=1, barrier=(29.7454,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.351646,'amu*angstrom^2'), symmetry=1, barrier=(8.69453,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.375854,'amu*angstrom^2'), symmetry=1, barrier=(8.68515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.19565,'amu*angstrom^2'), symmetry=1, barrier=(29.7558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.18102,'amu*angstrom^2'), symmetry=1, barrier=(29.743,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (89.1131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3886,0.0588359,-4.1894e-05,1.55775e-08,-2.46009e-12,-822.004,24.0973], Tmin=(100,'K'), Tmax=(1408.64,'K')), NASAPolynomial(coeffs=[10.3065,0.0335122,-1.49278e-05,2.81509e-09,-1.95052e-13,-3334.41,-21.9818], Tmin=(1408.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.60246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (28.8207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.121425,'amu*angstrom^2'), symmetry=1, barrier=(2.7918,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.58505,'amu*angstrom^2'), symmetry=1, barrier=(59.4355,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.789445,'amu*angstrom^2'), symmetry=1, barrier=(18.1509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121359,'amu*angstrom^2'), symmetry=1, barrier=(2.79028,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16384,0.0445927,-3.27368e-05,1.36337e-08,-2.59703e-12,3528.85,19.427], Tmin=(100,'K'), Tmax=(1131.34,'K')), NASAPolynomial(coeffs=[6.099,0.0306795,-1.429e-05,2.76359e-09,-1.95014e-13,2638.44,-0.043538], Tmin=(1131.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.8207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCOOH)"""),
)
...
"""),
    E0 = (1.29886,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5],'cm^-1')),
        HinderedRotor(inertia=(0.156164,'amu*angstrom^2'), symmetry=1, barrier=(3.59052,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155221,'amu*angstrom^2'), symmetry=1, barrier=(3.56884,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.41628,'amu*angstrom^2'), symmetry=1, barrier=(55.5551,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.4147,'amu*angstrom^2'), symmetry=1, barrier=(78.5106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18439,0.0441431,-3.43714e-05,1.81808e-08,-4.91866e-12,217.924,17.6664], Tmin=(100,'K'), Tmax=(797.319,'K')), NASAPolynomial(coeffs=[4.0793,0.0346366,-1.64867e-05,3.22662e-09,-2.29708e-13,-84.2426,8.95382], Tmin=(797.319,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.29886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC)"""),
)
...
"""),
    E0 = (-84.0159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2950,3100,1380,975,1025,1650],'cm^-1')),
        HinderedRotor(inertia=(0.221879,'amu*angstrom^2'), symmetry=1, barrier=(6.04143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201762,'amu*angstrom^2'), symmetry=1, barrier=(6.03921,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194393,'amu*angstrom^2'), symmetry=1, barrier=(6.02815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.74299,'amu*angstrom^2'), symmetry=1, barrier=(22.8805,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08216,0.0485664,-2.96894e-05,9.04803e-09,-1.19569e-12,-10042,20.3847], Tmin=(100,'K'), Tmax=(1528.19,'K')), NASAPolynomial(coeffs=[7.46228,0.034484,-1.58667e-05,3.01794e-09,-2.09211e-13,-11686.4,-7.85283], Tmin=(1528.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-84.0159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.753683,'amu*angstrom^2'), symmetry=1, barrier=(17.3286,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9747,0.0381673,-1.84064e-05,-9.20148e-10,2.3202e-12,-5000.17,18.7912], Tmin=(100,'K'), Tmax=(1127.51,'K')), NASAPolynomial(coeffs=[10.2353,0.0196668,-8.16859e-06,1.52573e-09,-1.06622e-13,-7549.76,-25.0983], Tmin=(1127.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.2243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    molecularWeight = (89.1131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43829,0.0615819,-6.41623e-05,5.22208e-08,-2.01257e-11,-4187.75,21.1698], Tmin=(100,'K'), Tmax=(706.944,'K')), NASAPolynomial(coeffs=[3.52451,0.045725,-2.19179e-05,4.27405e-09,-3.02357e-13,-4381.45,12.5448], Tmin=(706.944,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOOC)"""),
)

species(
    label = '[CH2]OOC(C)C(1403)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {3,S}
2  O u0 p2 c0 {1,S} {6,S}
...
"""),
    ...
    molecularWeight = (89.1131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13652,0.0594172,-4.04149e-05,1.37548e-08,-1.91947e-12,-3258.24,22.0198], Tmin=(100,'K'), Tmax=(1625.18,'K')), NASAPolynomial(coeffs=[13.4474,0.0291166,-1.2448e-05,2.28235e-09,-1.54658e-13,-7259.68,-43.3512], Tmin=(1625.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.9682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]COOC(1400)'],
    products = ['[CH2]C(C)OOC(1365)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(25)', '[CH2]C(C)OO(511)'],
    products = ['[CH2]C(C)OOC(1365)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(19)', 'C[CH]OOC(376)'],
    products = ['[CH2]C(C)OOC(1365)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.73526e+06,'m^3/(mol*s)'), n=0.377732, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H/CsO;Birad]

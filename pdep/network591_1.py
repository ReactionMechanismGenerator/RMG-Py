...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.634922,'amu*angstrom^2'), symmetry=1, barrier=(14.5981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.517332,'amu*angstrom^2'), symmetry=1, barrier=(11.8945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0990791,'amu*angstrom^2'), symmetry=1, barrier=(14.2393,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64031,0.0485018,-4.93526e-05,2.34417e-08,-3.49326e-12,6874.44,17.8338], Tmin=(100,'K'), Tmax=(929.213,'K')), NASAPolynomial(coeffs=[12.2779,0.0113834,-3.4348e-06,5.43128e-10,-3.51371e-14,4523.07,-34.7204], Tmin=(929.213,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.4251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C=C(O)CJ)"""),
)

species(
    label = 'C=C([O])COC=O(608)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47341,0.0483045,-3.16798e-05,8.14183e-09,-1.65263e-13,-44982.6,25.2632], Tmin=(100,'K'), Tmax=(1195.83,'K')), NASAPolynomial(coeffs=[12.3057,0.0210378,-8.72548e-06,1.6156e-09,-1.11836e-13,-48214.4,-31.6142], Tmin=(1195.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.05575,'amu*angstrom^2'), symmetry=1, barrier=(40.2008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.0576,'amu*angstrom^2'), symmetry=1, barrier=(40.2037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.05704,'amu*angstrom^2'), symmetry=1, barrier=(40.2048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.054,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16547,0.028391,1.28357e-05,-3.98005e-08,1.7487e-11,-3807.39,23.7698], Tmin=(100,'K'), Tmax=(992.896,'K')), NASAPolynomial(coeffs=[13.4555,0.0114701,-4.7515e-06,9.80798e-10,-7.61756e-14,-7457.26,-37.7075], Tmin=(992.896,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(C=CJO)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97489,0.00612223,6.245e-05,-9.43912e-08,3.93243e-11,2973,8.45923], Tmin=(100,'K'), Tmax=(918.024,'K')), NASAPolynomial(coeffs=[14.1099,0.000132024,2.7505e-06,-5.76178e-10,3.43072e-14,-863.475,-54.0687], Tmin=(918.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(methyleneoxirane)"""),
)

species(
    label = 'O=COO[C]1CC1(1073)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71203,0.0327258,3.5424e-05,-7.0658e-08,2.89373e-11,-12261.5,22.9693], Tmin=(100,'K'), Tmax=(994.123,'K')), NASAPolynomial(coeffs=[15.8829,0.0185119,-7.71586e-06,1.58444e-09,-1.22183e-13,-17194.1,-55.952], Tmin=(994.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdOsH) + ring(Cyclopropane) + radical(C2CsJOOC)"""),
)

species(
    label = 'C=C1CO[CH]OO1(1074)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61017,0.037227,1.74804e-05,-4.76622e-08,1.92397e-11,750.879,18.8851], Tmin=(100,'K'), Tmax=(1058.47,'K')), NASAPolynomial(coeffs=[15.5429,0.020754,-1.04463e-05,2.21964e-09,-1.6897e-13,-4225.32,-58.6979], Tmin=(1058.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.41831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(OCJO)"""),
)

species(
    label = 'C=C1CC([O])OO1(1075)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    E0 = (-117.381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,1855,455,950],'cm^-1')),
        HinderedRotor(inertia=(1.45034,'amu*angstrom^2'), symmetry=1, barrier=(33.3462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44553,'amu*angstrom^2'), symmetry=1, barrier=(33.2357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44933,'amu*angstrom^2'), symmetry=1, barrier=(33.323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44565,'amu*angstrom^2'), symmetry=1, barrier=(33.2383,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09719,0.0533695,-2.83608e-05,-4.43742e-09,5.90614e-12,-14004.1,25.1087], Tmin=(100,'K'), Tmax=(1042.53,'K')), NASAPolynomial(coeffs=[15.691,0.0181893,-7.69057e-06,1.49504e-09,-1.08808e-13,-18178.1,-51.3308], Tmin=(1042.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical((O)CJOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)OOC=O(620)'],
    products = ['CO2(4)', 'C=C(C)[O](282)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5.2199e+12,'s^-1'), n=-0.232363, Ea=(60.5873,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.08178908396205459, var=5.664309242707326, Tref=1000.0, N=65, data_mean=0.0, correlation='Root_4R!H->C',), comment="""Estimated from node Root_4R!H->C in family Retroene.
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(15)', '[CH2]C(=C)OO(1051)'],
    products = ['[CH2]C(=C)OOC=O(620)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=C)OOC=O(620)'],
    products = ['C=C([O])COC=O(608)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.61582e+26,'s^-1'), n=-3.67984, Ea=(151.488,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.4163866947181062, var=128.1927359939506, Tref=1000.0, N=20, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root in family 1,3_sigmatropic_rearrangement.
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(19)', 'C=[C]OOC=O(1072)'],
    products = ['[CH2]C(=C)OOC=O(620)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(=C)OOC=O(620)'],
    products = ['[O]C=O(118)', 'C=C1CO1(357)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(=C)OOC=O(620)'],
    products = ['O=COO[C]1CC1(1073)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.95187e+18,'s^-1'), n=-1.62813, Ea=(137.117,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.08275800860939324, var=25.73102631834909, Tref=1000.0, N=5, data_mean=0.0, correlation='Backbone0_N-2R!H-inRing_N-1R!H-inRing_Sp-2R!H-1R!H',), comment="""Estimated from node Backbone0_N-2R!H-inRing_N-1R!H-inRing_Sp-2R!H-1R!H in family Intra_R_Add_Endocyclic."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(=C)OOC=O(620)'],
    products = ['C=C1CO[CH]OO1(1074)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(15004.7,'s^-1'), n=1.77834, Ea=(169.979,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.0014543516552546268, var=0.2904233102736748, Tref=1000.0, N=2, data_mean=0.0, correlation='Backbone3_N-Sp-4R!H=1R!H_Sp-2R!H-1R!H_N-2R!H-inRing_Ext-4R!H-R_N-1R!H-inRing',), comment="""Estimated from node Backbone3_N-Sp-4R!H=1R!H_Sp-2R!H-1R!H_N-2R!H-inRing_Ext-4R!H-R_N-1R!H-inRing in family Intra_R_Add_Endocyclic.
Multiplied by reaction path degeneracy 2.0"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(=C)OOC=O(620)'],
    products = ['C=C1CC([O])OO1(1075)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.468078,'s^-1'), n=3.38729, Ea=(165.451,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.23174178600410858, var=45.068923389250436, Tref=1000.0, N=140, data_mean=0.0, correlation='Backbone3',), comment="""Estimated from node Backbone3 in family Intra_R_Add_Exocyclic.
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction9',
    reactants = ['[O]OC=O(104)', 'C3H4a(40)'],
    products = ['[CH2]C(=C)OOC=O(620)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(0.000692465,'m^3/(mol*s)'), n=2.43792, Ea=(4.66472,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Cdd_Cds;OJ-O2s] for rate rule [Ca_Cds-HH;OJ-O2s]
...
reaction(
    label = 'reaction11',
    reactants = ['C=C(C)OO[C]=O(615)'],
    products = ['[CH2]C(=C)OOC=O(620)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(4.80135e+06,'s^-1'), n=1.37273, Ea=(58.7699,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_SSSS;Y_rad_out;Cs_H_out_2H] for rate rule [R5H_SSSS;CO_rad_out;Cs_H_out_2H]

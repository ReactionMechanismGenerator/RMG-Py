...
reaction(
    label = 'reaction1',
    reactants = ['CH2(19)', 'CH3(21)'],
    products = ['C2H5(31)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.73526e+06,'m^3/(mol*s)'), n=0.377732, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_methyl;Birad]

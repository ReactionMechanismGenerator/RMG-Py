...
"""),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75297,0.0499624,-4.00235e-05,1.82456e-08,-3.56817e-12,-24337.3,21.8824], Tmin=(100,'K'), Tmax=(1177.33,'K')), NASAPolynomial(coeffs=[8.32689,0.0276276,-1.15676e-05,2.13253e-09,-1.46671e-13,-25885.2,-10.9062], Tmin=(1177.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-203.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.222648,'amu*angstrom^2'), symmetry=1, barrier=(5.11911,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222065,'amu*angstrom^2'), symmetry=1, barrier=(5.10572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44486,'amu*angstrom^2'), symmetry=1, barrier=(33.2203,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51486,0.035917,-3.08383e-05,1.87549e-08,-5.69802e-12,23806.7,19.99], Tmin=(100,'K'), Tmax=(734.71,'K')), NASAPolynomial(coeffs=[4.12257,0.0271642,-1.29689e-05,2.54065e-09,-1.80886e-13,23570.5,12.7293], Tmin=(734.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74461,0.0438057,-1.97383e-05,1.21768e-09,8.4326e-13,15366.6,20.3375], Tmin=(100,'K'), Tmax=(1428.71,'K')), NASAPolynomial(coeffs=[11.3558,0.0265148,-1.16823e-05,2.17037e-09,-1.47926e-13,11638.7,-32.8954], Tmin=(1428.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(C2CsJOOC)"""),
)
...
"""),
    E0 = (109.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.369449,'amu*angstrom^2'), symmetry=1, barrier=(8.49437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369434,'amu*angstrom^2'), symmetry=1, barrier=(8.49402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0144413,'amu*angstrom^2'), symmetry=1, barrier=(31.0451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.35026,'amu*angstrom^2'), symmetry=1, barrier=(31.045,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86573,0.0506164,-3.69617e-05,1.4377e-08,-2.43718e-12,13253,20.8754], Tmin=(100,'K'), Tmax=(1292.13,'K')), NASAPolynomial(coeffs=[8.11176,0.0312805,-1.45148e-05,2.79551e-09,-1.96367e-13,11638.9,-10.8588], Tmin=(1292.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CsJOOC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)OOC(633)'],
    products = ['CH2O(20)', 'C=C(C)[O](282)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.56597e+13,'s^-1'), n=-0.232363, Ea=(76.1063,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.08178908396205459, var=5.664309242707326, Tref=1000.0, N=65, data_mean=0.0, correlation='Root_4R!H->C',), comment="""Estimated from node Root_4R!H->C in family Retroene.
Multiplied by reaction path degeneracy 6.0"""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', '[CH2]C(=C)OO(1051)'],
    products = ['[CH2]C(=C)OOC(633)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(=C)OOC(633)'],
    products = ['C=C([O])COC(630)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(4.61582e+26,'s^-1'), n=-3.67984, Ea=(130.829,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.4163866947181062, var=128.1927359939506, Tref=1000.0, N=20, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root in family 1,3_sigmatropic_rearrangement.
Multiplied by reaction path degeneracy 2.0"""),
)

reaction(
    label = 'reaction4',
    reactants = ['CH2(19)', 'C=[C]OOC(368)'],
    products = ['[CH2]C(=C)OOC(633)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(=C)OOC(633)'],
    products = ['CH3O(26)', 'C=C1CO1(357)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(7.96e+12,'s^-1','*|/',1.2), n=0, Ea=(63.953,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 2 C4H7O2 <=> C3H4O + CH3O in Cyclic_Ether_Formation/training
This reaction matched rate rule [R2OO_S;C_pri_rad_intra;OOR]

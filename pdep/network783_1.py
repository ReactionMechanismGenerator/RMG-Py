...
"""),
    E0 = (-315.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2950,3150,900,1000,1100,2782.5,750,1395,475,1775,1000,180,998.019,998.019,998.019,998.019,998.019,998.019,998.019,998.019,998.019,2280.96],'cm^-1')),
        HinderedRotor(inertia=(0.0423586,'amu*angstrom^2'), symmetry=1, barrier=(0.973907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0423586,'amu*angstrom^2'), symmetry=1, barrier=(0.973907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0423586,'amu*angstrom^2'), symmetry=1, barrier=(0.973907,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13473,0.0340225,6.63639e-05,-1.28317e-07,5.58307e-11,-37772.1,25.2234], Tmin=(100,'K'), Tmax=(943.103,'K')), NASAPolynomial(coeffs=[26.2505,0.000958146,2.11514e-06,-3.09694e-10,4.83754e-15,-45776.4,-111.795], Tmin=(943.103,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-315.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(Cyclobutene)"""),
)
...
"""),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8744,0.0312328,3.07826e-05,-5.95128e-08,2.32634e-11,-64883.4,24.3321], Tmin=(100,'K'), Tmax=(1033.13,'K')), NASAPolynomial(coeffs=[13.9683,0.021944,-1.02286e-05,2.11813e-09,-1.60093e-13,-69385.5,-44.1027], Tmin=(1033.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-540.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsOsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + group(Cds-OdOsH) + ring(Cyclobutane)"""),
)
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3570.08,'J/mol'), sigma=(4.79062,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=557.64 K, Pc=73.68 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    E0 = (-121.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,3150,900,1100,2782.5,750,1395,475,1775,1000,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.766824,0.043424,3.94852e-05,-1.05718e-07,4.94477e-11,-14435.9,25.3245], Tmin=(100,'K'), Tmax=(936.902,'K')), NASAPolynomial(coeffs=[28.7285,-0.00548112,4.95273e-06,-8.5967e-10,4.42181e-14,-22768.4,-124.259], Tmin=(936.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-121.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(Cyclobutene) + radical(CCsJOC(O))"""),
)

species(
    label = 'O=COOC1=[C]OC1(1405)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (115.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34807,0.0357348,3.9661e-05,-8.97924e-08,3.97308e-11,-8951.24,27.5866], Tmin=(100,'K'), Tmax=(954.931,'K')), NASAPolynomial(coeffs=[22.1424,0.00503119,-7.02097e-07,2.35151e-10,-3.03251e-14,-15494.2,-85.2397], Tmin=(954.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.3897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(Cyclobutene) + radical(C=CJO)"""),
)

species(
    label = 'O=[C]OOC1=COC1(1406)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0581648,'amu*angstrom^2'), symmetry=1, barrier=(1.33732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0581648,'amu*angstrom^2'), symmetry=1, barrier=(1.33732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0581648,'amu*angstrom^2'), symmetry=1, barrier=(1.33732,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (115.064,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.929753,0.0417313,3.84711e-05,-1.00355e-07,4.66346e-11,-14140.3,24.5868], Tmin=(100,'K'), Tmax=(936.525,'K')), NASAPolynomial(coeffs=[26.5595,-0.00208707,3.50617e-06,-6.1552e-10,2.9265e-14,-21819.8,-112.751], Tmin=(936.525,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-OdOsH) + ring(Cyclobutene) + radical((O)CJOC)"""),
)

species(
    label = 'O=COOC1[C-]=[O+]C1(1407)',
...
7  C u0 p0 c0 {3,S} {4,D} {12,S}
8  C u0 p1 c-1 {2,D} {5,S}
9  H u0 p0 c0 {5,S}
10 H u0 p0 c0 {6,S}
11 H u0 p0 c0 {6,S}
12 H u0 p0 c0 {7,S}
"""),
    E0 = (71.9284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2950,3150,900,1000,1100,2782.5,750,1395,475,1775,1000,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.994036,0.049555,-4.0564e-06,-3.53871e-08,1.72433e-11,8773.64,14.5162], Tmin=(100,'K'), Tmax=(1034.39,'K')), NASAPolynomial(coeffs=[19.6812,0.0145836,-7.4221e-06,1.63613e-09,-1.28678e-13,2912.61,-85.9142], Tmin=(1034.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.9284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-CsCsCsCs) + group(Cds-OdOsH) + group(CsJ2_singlet-CsH) + ring(Cyclobutene)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O=COOC1=COC1(860)'],
    products = ['CO2(4)', 'O=C1COC1(290)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.60995e+12,'s^-1'), n=-0.232363, Ea=(68.8487,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.08178908396205459, var=5.664309242707326, Tref=1000.0, N=65, data_mean=0.0, correlation='Root_4R!H->C',), comment="""Estimated from node Root_4R!H->C in family Retroene."""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO(15)', 'OOC1=COC1(1097)'],
    products = ['O=COOC1=COC1(860)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[O]OC=O(104)', '[C]1=COC1(952)'],
    products = ['O=COOC1=COC1(860)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['HCO(16)', '[O]OC1=COC1(1099)'],
    products = ['O=COOC1=COC1(860)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(5)', 'O=COOC1=CO[CH]1(1404)'],
    products = ['O=COOC1=COC1(860)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(5)', 'O=COOC1=[C]OC1(1405)'],
    products = ['O=COOC1=COC1(860)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(5)', 'O=[C]OOC1=COC1(1406)'],
    products = ['O=COOC1=COC1(860)'],
    transitionState = 'TS9',

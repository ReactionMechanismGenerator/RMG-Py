...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.958584,'amu*angstrom^2'), symmetry=1, barrier=(22.0397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959085,'amu*angstrom^2'), symmetry=1, barrier=(22.0513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959097,'amu*angstrom^2'), symmetry=1, barrier=(22.0515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.959096,'amu*angstrom^2'), symmetry=1, barrier=(22.0515,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.887413,0.0580618,-3.99161e-05,2.48936e-11,6.84346e-12,-21095.9,20.4713], Tmin=(100,'K'), Tmax=(963.146,'K')), NASAPolynomial(coeffs=[18.1773,0.0103602,-3.16541e-06,5.71035e-10,-4.28858e-14,-25544.5,-68.097], Tmin=(963.146,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
"""),
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3504.08,'J/mol'), sigma=(5.07719,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=547.33 K, Pc=60.75 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.10285,0.0158474,4.6039e-06,-1.38973e-08,5.60965e-12,-8210.16,11.771], Tmin=(100,'K'), Tmax=(1026.11,'K')), NASAPolynomial(coeffs=[5.93069,0.0137122,-5.26829e-06,9.58653e-10,-6.66256e-14,-9258.42,-4.22467], Tmin=(1026.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-68.5596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""CH3CHOH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-231.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2388.64],'cm^-1')),
        HinderedRotor(inertia=(0.139632,'amu*angstrom^2'), symmetry=1, barrier=(3.21041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471384,'amu*angstrom^2'), symmetry=1, barrier=(10.838,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (61.0599,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.2451,0.0229431,-9.99655e-06,1.53634e-09,-4.21782e-14,-27773.5,14.5313], Tmin=(100,'K'), Tmax=(2344.37,'K')), NASAPolynomial(coeffs=[14.1232,0.00901962,-4.0547e-06,6.90332e-10,-4.19292e-14,-34148.2,-49.9353], Tmin=(2344.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-231.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.17635,'amu*angstrom^2'), symmetry=1, barrier=(27.0465,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.468341,0.0593038,-6.31889e-05,3.11475e-08,-5.6264e-12,24711.6,18.2746], Tmin=(100,'K'), Tmax=(1599.78,'K')), NASAPolynomial(coeffs=[18.3873,0.00255396,1.22265e-06,-3.62234e-10,2.71363e-14,20507.1,-71.8156], Tmin=(1599.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs)"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.272695,'amu*angstrom^2'), symmetry=1, barrier=(14.0941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272696,'amu*angstrom^2'), symmetry=1, barrier=(14.0941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.272695,'amu*angstrom^2'), symmetry=1, barrier=(14.0941,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01088,0.0668799,-7.87904e-05,4.79998e-08,-1.16246e-11,133.037,21.1279], Tmin=(100,'K'), Tmax=(1006.11,'K')), NASAPolynomial(coeffs=[12.8003,0.0200087,-8.91093e-06,1.69659e-09,-1.19125e-13,-2239.26,-35.8211], Tmin=(1006.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.218556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COC(C)O(431)'],
    products = ['CH2CO(27)', 'CH3CHO(37)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.46545e+14,'s^-1'), n=0.20628, Ea=(7.71125,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-4R!H->C',), comment="""Estimated from node Root_N-4R!H->C in family Retroene."""),
)

reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'C#COCO(292)'],
    products = ['C#COC(C)O(431)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(21)', 'C#CO[CH]O(880)'],
    products = ['C#COC(C)O(431)'],
    transitionState = 'TS8',

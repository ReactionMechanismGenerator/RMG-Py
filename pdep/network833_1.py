...
"""),
    E0 = (-75.8774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13117,0.0895495,-9.69265e-05,4.86102e-08,-9.00328e-12,-8921.21,30.4884], Tmin=(100,'K'), Tmax=(1528.2,'K')), NASAPolynomial(coeffs=[25.9082,0.00423371,1.08806e-06,-3.74502e-10,2.88018e-14,-15487.5,-105.872], Tmin=(1528.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.8774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOC(O))"""),
)
...
"""),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.957559,0.0696751,-7.38174e-05,4.26432e-08,-1.01327e-11,-44893.4,27.4319], Tmin=(100,'K'), Tmax=(1007.1,'K')), NASAPolynomial(coeffs=[11.1965,0.0290085,-1.32478e-05,2.54845e-09,-1.79769e-13,-46955.7,-22.0375], Tmin=(1007.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-374.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs)"""),
)

species(
    label = 'CC1O[CH]C1OO(1412)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.235099,0.0711961,-6.54576e-05,3.10847e-08,-5.54197e-12,-6233.35,26.4564], Tmin=(100,'K'), Tmax=(1634.75,'K')), NASAPolynomial(coeffs=[16.3816,0.016469,-2.33267e-06,7.72659e-11,5.03507e-15,-9786.33,-56.1267], Tmin=(1634.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOCs)"""),
)
...
"""),
    E0 = (-114.484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.04523,'amu*angstrom^2'), symmetry=1, barrier=(24.0319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04495,'amu*angstrom^2'), symmetry=1, barrier=(24.0255,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.04605,'amu*angstrom^2'), symmetry=1, barrier=(24.0507,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.617417,0.0615605,-3.29995e-05,-1.39057e-08,1.33044e-11,-13635.7,27.0823], Tmin=(100,'K'), Tmax=(941.512,'K')), NASAPolynomial(coeffs=[20.1119,0.0105737,-2.48735e-06,4.02388e-10,-3.09017e-14,-18717.6,-73.2855], Tmin=(941.512,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-114.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
"""),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60347,0.0309697,-3.50664e-05,2.09974e-08,-5.02675e-12,25038.5,14.9623], Tmin=(100,'K'), Tmax=(1015.85,'K')), NASAPolynomial(coeffs=[7.89856,0.0101204,-4.28119e-06,7.94674e-10,-5.49963e-14,23962.7,-10.6669], Tmin=(1015.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""CHCHOOH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-58.2157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.897038,0.0850696,-8.86401e-05,4.33657e-08,-7.87915e-12,-6806.01,30.8116], Tmin=(100,'K'), Tmax=(1551.56,'K')), NASAPolynomial(coeffs=[24.4362,0.00660439,-6.47528e-08,-1.57368e-10,1.41273e-14,-13083.8,-97.4321], Tmin=(1551.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.2157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJCO)"""),
)

species(
    label = 'CCO[C]=COO(1415)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {4,S} {7,S}
2  O u0 p2 c0 {3,S} {6,S}
3  O u0 p2 c0 {2,S} {14,S}
...
"""),
    E0 = (-30.0606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.337909,0.071585,-6.16385e-05,2.0019e-08,-1.11987e-13,-3475.63,28.8583], Tmin=(100,'K'), Tmax=(984.351,'K')), NASAPolynomial(coeffs=[18.348,0.0166565,-5.75728e-06,1.01502e-09,-7.09426e-14,-7905.8,-62.239], Tmin=(984.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.0606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=CJO)"""),
)
...
"""),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.443923,0.0656206,-3.73116e-05,-1.22293e-08,1.35231e-11,-14028.4,26.1086], Tmin=(100,'K'), Tmax=(927.349,'K')), NASAPolynomial(coeffs=[20.4915,0.0115691,-2.32435e-06,3.18602e-10,-2.30781e-14,-19140.7,-76.6137], Tmin=(927.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.8,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C[CH]OC=COO(1162)'],
    products = ['C[CH]OC(O)C=O(1411)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.30791e+26,'s^-1'), n=-3.67984, Ea=(123.841,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.4163866947181062, var=128.1927359939506, Tref=1000.0, N=20, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root in family 1,3_sigmatropic_rearrangement."""),
)

reaction(
    label = 'reaction3',
    reactants = ['C[CH]OC=COO(1162)'],
    products = ['CC1O[CH]C1OO(1412)'],
    transitionState = 'TS3',
...
reaction(
    ...
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(3.36539e+09,'s^-1'), n=0.84129, Ea=(2.83091,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.031430614527560546, var=6.099077214950256, Tref=1000.0, N=84, data_mean=0.0, correlation='Backbone1',), comment="""Estimated from node Backbone1 in family Intra_R_Add_Exocyclic."""),
)

reaction(
    label = 'reaction5',
    reactants = ['H(5)', 'C=COC=COO(1413)'],
    products = ['C[CH]OC=COO(1162)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=COO(153)', 'CH3CHO(37)'],
    products = ['C[CH]OC=COO(1162)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]OC=COO(1162)'],
    products = ['OH(9)', 'CCOC=C=O(1416)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(20.7716,'s^-1'), n=2.90518, Ea=(83.3195,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_RSR;C_rad_out_H/NonDeC;XH_out] for rate rule [R4H_SSD;C_rad_out_H/NonDeC;Cd_H_out_singleNd]
Euclidian distance = 2.8284271247461903
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]OC=COO(1162)'],
    products = ['CCOC=CO[O](1417)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(46.1,'s^-1'), n=3.21, Ea=(60.7935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6H;C_rad_out_H/NonDeC;XH_out] for rate rule [R6H_RSMSR;C_rad_out_H/NonDeC;O_H_out]

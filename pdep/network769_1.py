...
"""),
    E0 = (-209.739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2950,3150,900,1000,1100,300,800,800,800,800,800,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09903,0.0157911,7.6977e-05,-1.34465e-07,5.95613e-11,-25132.9,12.9278], Tmin=(100,'K'), Tmax=(907.223,'K')), NASAPolynomial(coeffs=[23.9425,-0.0120619,9.84386e-06,-1.95916e-09,1.27566e-13,-31913.5,-105.854], Tmin=(907.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=C1COO1(289)'],
    products = ['O=C1COC1(290)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(5.95588e+67,'s^-1'), n=-15.1817, Ea=(282.179,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=1.5544159323717395, var=269.88167642966965, Tref=1000.0, N=8, data_mean=0.0, correlation='Root_1R!H-inRing',), comment="""Estimated from node Root_1R!H-inRing in family 1,3_sigmatropic_rearrangement."""),
)

reaction(
    label = 'reaction1',
    reactants = ['CH2O(20)', 'CH2CO(27)'],
    products = ['O=C1COC1(290)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(2.73271e-32,'m^3/(mol*s)'), n=10.9581, Ea=(67.2735,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-1COCSCdCdd->Cd',), comment="""Estimated from node Root_N-1COCSCdCdd->Cd in family 2+2_cycloaddition."""),
)

reaction(
    label = 'reaction3',
    reactants = ['OC1=COC1(847)'],
    products = ['O=C1COC1(290)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(8.47848e-14,'s^-1'), n=7.46671, Ea=(189.86,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_3R!H->C_3C-inRing_Ext-1R!H-R_5R!H->C_Ext-3C-R_N-6R!H->N_6BrCClFIOPSSi->O',), comment="""Estimated from node Root_3R!H->C_3C-inRing_Ext-1R!H-R_5R!H->C_Ext-3C-R_N-6R!H->N_6BrCClFIOPSSi->O in family Ketoenol."""),
)

reaction(
    label = 'reaction4',
    reactants = ['H(5)', '[O]C1=COC1(848)'],
    products = ['O=C1COC1(290)'],
    transitionState = 'TS4',

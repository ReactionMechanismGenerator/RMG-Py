...
"""),
    E0 = (90.8656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2950,3100,1380,975,1025,1650,180,918.834,918.839,918.839,918.839,918.84,918.84,918.841,918.843,918.844,918.847],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00140592,'amu*angstrom^2'), symmetry=1, barrier=(15.7189,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.5908,'amu*angstrom^2'), symmetry=1, barrier=(24.6849,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1006,0.0390388,-3.24233e-05,1.44111e-08,-2.61594e-12,-16270.2,18.6571], Tmin=(100,'K'), Tmax=(1305.77,'K')), NASAPolynomial(coeffs=[9.47781,0.0164399,-6.46269e-06,1.15666e-09,-7.82693e-14,-18196.8,-18.9019], Tmin=(1305.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-135.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)

species(
    label = 'O[C]1COOC1(797)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {4,S}
2  O u0 p2 c0 {1,S} {5,S}
...
"""),
    ...
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.885628,0.0503925,-4.50622e-05,2.15621e-08,-3.84438e-12,-14336.5,21.2268], Tmin=(100,'K'), Tmax=(1684.89,'K')), NASAPolynomial(coeffs=[11.0093,0.013915,-1.5094e-06,-5.39227e-11,1.33545e-14,-15981.7,-27.6539], Tmin=(1684.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-120.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxolane) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1(O)COO1(798)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {2,S} {4,S}
2  O u0 p2 c0 {1,S} {5,S}
...
"""),
    ...
    molecularWeight = (89.07,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19264,0.0459557,-2.3432e-06,-4.61381e-08,2.57018e-11,-5938.6,18.8795], Tmin=(100,'K'), Tmax=(919.951,'K')), NASAPolynomial(coeffs=[20.7837,0.00205816,1.91546e-06,-4.40958e-10,2.64229e-14,-11290.2,-83.4968], Tmin=(919.951,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.3388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction24',
    reactants = ['C=C(O)CO[O](645)'],
    products = ['O[C]1COOC1(797)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(3966.13,'s^-1'), n=2.06722, Ea=(88.7868,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-1.0830709899023956, var=2.708078064221746, Tref=1000.0, N=3, data_mean=0.0, correlation='Backbone2_N-Sp-3R!H=1R!H_N-1R!H-inRing_Sp-4R!H-3R!H_Ext-2R!H-R',), comment="""Estimated from node Backbone2_N-Sp-3R!H=1R!H_N-1R!H-inRing_Sp-4R!H-3R!H_Ext-2R!H-R in family Intra_R_Add_Endocyclic."""),
)

reaction(
    label = 'reaction25',
    reactants = ['C=C(O)CO[O](645)'],
    products = ['[CH2]C1(O)COO1(798)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(2.29992e-11,'s^-1'), n=6.41391, Ea=(87.7222,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=-0.060263897582951434, var=9.993740724871635, Tref=1000.0, N=74, data_mean=0.0, correlation='Backbone2',), comment="""Estimated from node Backbone2 in family Intra_R_Add_Exocyclic.
Ea raised from 87.0 to 87.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction26',
    reactants = ['O2(2)', '[CH2]C(=C)O(594)'],
    products = ['C=C(O)CO[O](645)'],

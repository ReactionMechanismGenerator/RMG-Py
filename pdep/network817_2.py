...
"""),
    ...
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35974,-0.0184762,0.000228223,-3.29823e-07,1.39095e-10,-34019.6,10.5489], Tmin=(100,'K'), Tmax=(901.657,'K')), NASAPolynomial(coeffs=[39.6045,-0.0406937,2.72716e-05,-5.33583e-09,3.51656e-13,-46549.3,-197.516], Tmin=(901.657,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-283.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclopentane)"""),
)

species(
    label = '[CH]1OC=CO1(1155)',
    structure = adjacencyList("""multiplicity 2
1 O u0 p2 c0 {3,S} {5,S}
...
"""),
    E0 = (-94.813,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,557.505,557.505,557.505,557.505,557.505,557.505,557.505,557.505,557.505,557.505,557.505,557.505],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0546,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31756,-0.00219072,0.000147822,-2.26048e-07,9.72215e-11,-11305.9,10.4894], Tmin=(100,'K'), Tmax=(900.807,'K')), NASAPolynomial(coeffs=[31.4226,-0.0282397,1.93672e-05,-3.8139e-09,2.52249e-13,-20736.2,-150.124], Tmin=(900.807,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclopentane) + radical(OCJO)"""),
)

species(
    label = 'C[C]1OC=CO1(1156)',
    structure = adjacencyList("""multiplicity 2
...
"""),
    ...
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93812,0.00560376,0.000147093,-2.24393e-07,9.49015e-11,-14844.3,15.8267], Tmin=(100,'K'), Tmax=(912.897,'K')), NASAPolynomial(coeffs=[30.6024,-0.0165202,1.34264e-05,-2.61939e-09,1.66224e-13,-24389.5,-143.465], Tmin=(912.897,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclopentane) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C1OC=CO1(1157)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {3,S} {4,S}
2  O u0 p2 c0 {3,S} {5,S}
3  C u0 p0 c0 {1,S} {2,S} {6,S} {7,S}
...
"""),
    ...
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74462,0.0101037,0.000137657,-2.17343e-07,9.3142e-11,-14074.7,16.4672], Tmin=(100,'K'), Tmax=(911.102,'K')), NASAPolynomial(coeffs=[31.6477,-0.018049,1.42167e-05,-2.78246e-09,1.78229e-13,-23804.1,-148.504], Tmin=(911.102,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-118.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclopentane) + radical(CJCO)"""),
)

species(
    label = 'CC1O[C]=CO1(1158)',
    structure = adjacencyList("""multiplicity 2
1  O u0 p2 c0 {3,S} {5,S}
2  O u0 p2 c0 {3,S} {6,S}
3  C u0 p0 c0 {1,S} {2,S} {4,S} {7,S}
...
"""),
    ...
    molecularWeight = (85.0812,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11496,0.00658528,0.000130767,-1.97903e-07,8.30788e-11,-10706.2,17.6323], Tmin=(100,'K'), Tmax=(915.827,'K')), NASAPolynomial(coeffs=[26.6546,-0.0100758,9.79679e-06,-1.92161e-09,1.196e-13,-18997.1,-119.325], Tmin=(915.827,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-89.8511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclopentane) + radical(C=CJO)"""),
)

species(
    label = 'CC1OC[C-]=[O+]1(1159)',
    structure = adjacencyList("""1  O u0 p2 c0 {3,S} {5,S}
...
"""),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35659,0.0269522,1.88018e-05,-3.56744e-08,1.30529e-11,17594.3,17.029], Tmin=(100,'K'), Tmax=(1079.48,'K')), NASAPolynomial(coeffs=[8.47246,0.0265785,-1.16502e-05,2.25937e-09,-1.62021e-13,14975.3,-18.9593], Tmin=(1079.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(Cs-CsHHH) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH) + ring(Cyclopentane)"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(S)(25)', 'C1=COCO1(1154)'],
    products = ['CC1OC=CO1(1135)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(21)', '[CH]1OC=CO1(1155)'],
    products = ['CC1OC=CO1(1135)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(7.49725e+08,'m^3/(mol*s)'), n=-0.546607, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.0173097986373, var=0.452291225768, Tref=1000.0, N=9, data_mean=0.0, correlation='Root_N-1R->H_N-1CNOS->N_N-1COS->O_1CS->C_1C-inRing',), comment="""Estimated from node Root_N-1R->H_N-1CNOS->N_N-1COS->O_1CS->C_1C-inRing in family R_Recombination."""),
)

reaction(
    label = 'reaction16',
    reactants = ['H(5)', 'C[C]1OC=CO1(1156)'],
    products = ['CC1OC=CO1(1135)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(5)', '[CH2]C1OC=CO1(1157)'],
    products = ['CC1OC=CO1(1135)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC1OC[C-]=[O+]1(1159)'],
    products = ['CC1OC=CO1(1135)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(7.90318e+18,'s^-1'), n=-1.97082, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.8305765209480382, var=17.041866923497537, Tref=1000.0, N=4, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root in family Singlet_Carbene_Intra_Disproportionation.
Multiplied by reaction path degeneracy 2.0"""),
)

...
"""),
    ...
    molecularWeight = (43.0877,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.23519,0.0111016,2.80214e-05,-3.59459e-08,1.23657e-11,9053.76,11.9814], Tmin=(100,'K'), Tmax=(1029.98,'K')), NASAPolynomial(coeffs=[4.36583,0.0214399,-8.48558e-06,1.56802e-09,-1.09813e-13,8039.56,2.70055], Tmin=(1029.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.0074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), label="""ipropyl""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00366436,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211928,'amu*angstrom^2'), symmetry=1, barrier=(6.83022,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.208597,'amu*angstrom^2'), symmetry=1, barrier=(6.83631,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.1143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22526,0.0309738,8.89513e-06,-2.91791e-08,1.23305e-11,6875.03,16.3965], Tmin=(100,'K'), Tmax=(997.968,'K')), NASAPolynomial(coeffs=[8.64392,0.0240461,-8.94856e-06,1.6168e-09,-1.12733e-13,4657.76,-19.2471], Tmin=(997.968,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.5721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), label="""ibutyl""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]CCC(90)'],
    products = ['H(5)', 'C=CCC(438)'],
    transitionState = 'TS3',

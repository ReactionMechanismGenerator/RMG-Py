...
reaction(
    ...
    products = ['C2H4(29)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(1.18548e+19,'s^-1'), n=-1.97082, Ea=(14.9501,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.8305765209480382, var=17.041866923497537, Tref=1000.0, N=4, data_mean=0.0, correlation='Root',), comment="""Estimated from node Root in family Singlet_Carbene_Intra_Disproportionation.

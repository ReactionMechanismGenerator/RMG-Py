...
"""),
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.84018,'amu*angstrom^2'), symmetry=1, barrier=(19.3174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.841559,'amu*angstrom^2'), symmetry=1, barrier=(19.3491,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0626,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26457,0.0472667,-4.99919e-05,2.52591e-08,-4.70703e-12,-28218,17.0415], Tmin=(100,'K'), Tmax=(1547.11,'K')), NASAPolynomial(coeffs=[14.4287,0.00423655,4.48834e-07,-2.34283e-10,1.97199e-14,-31214.8,-48.7336], Tmin=(1547.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-235.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)HHH) + group(Cds-(Cdd-O2d)CsOs) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-223.451,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,2110,2130,495,530,650,925,180],'cm^-1')),
        HinderedRotor(inertia=(1.21411,'amu*angstrom^2'), symmetry=1, barrier=(27.9148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.21051,'amu*angstrom^2'), symmetry=1, barrier=(27.832,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0567,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.62159,0.0639235,-7.83612e-05,4.39684e-08,-9.13023e-12,-26744.3,21.8818], Tmin=(100,'K'), Tmax=(1330.25,'K')), NASAPolynomial(coeffs=[18.9581,0.0010113,1.3462e-06,-3.71353e-10,2.84675e-14,-30934.9,-69.2284], Tmin=(1330.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-223.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + missing(O2d-Cdd) + missing(O2d-Cdd) + group(Cds-(Cdd-O2d)(Cds-Cdd-O2d)O2s) + group(Cds-(Cdd-O2d)(Cds-Cdd-O2d)H) + missing(Cdd-CdO2d) + missing(Cdd-CdO2d)"""),
)
...
"""),
    ...
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.474057,0.0741642,-8.14859e-05,4.3791e-08,-9.1912e-12,-77828.7,24.5395], Tmin=(100,'K'), Tmax=(1164.74,'K')), NASAPolynomial(coeffs=[17.1999,0.0167237,-7.51176e-06,1.45023e-09,-1.03181e-13,-81724.9,-58.7038], Tmin=(1164.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-648.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-O2d)H) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)O2s) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(O)OC(O)=C=O(1319)',
...
"""),
    E0 = (-404.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3650,1210,1345,900,1100,325,375,415,465,420,450,1700,1750,2950,3100,1380,975,1025,1650,2120,512.5,787.5,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.14755,'amu*angstrom^2'), symmetry=1, barrier=(26.3845,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14418,'amu*angstrom^2'), symmetry=1, barrier=(26.3069,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14277,'amu*angstrom^2'), symmetry=1, barrier=(26.2746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.14618,'amu*angstrom^2'), symmetry=1, barrier=(26.3529,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.14123,0.0983809,-0.000117573,6.09389e-08,-1.12381e-11,-48359.8,32.4446], Tmin=(100,'K'), Tmax=(1619.2,'K')), NASAPolynomial(coeffs=[29.7471,-0.00892536,8.26432e-06,-1.75354e-09,1.2157e-13,-54946.4,-125.217], Tmin=(1619.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-404.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + missing(O2d-Cdd) + group(Cds-CdsCsCs) + group(Cds-(Cdd-O2d)OsOs) + group(Cds-CdsHH) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-498.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3580,3615,3650,1210,1277.5,1345,900,1000,1100,3010,987.5,1337.5,450,1655,325,375,415,465,420,450,1700,1750,2120,512.5,787.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.930796,'amu*angstrom^2'), symmetry=1, barrier=(21.4008,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.933782,'amu*angstrom^2'), symmetry=1, barrier=(21.4695,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.931977,'amu*angstrom^2'), symmetry=1, barrier=(21.428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.932028,'amu*angstrom^2'), symmetry=1, barrier=(21.4291,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.072,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.57899,0.0947118,-0.000118772,5.88267e-08,-7.02731e-12,-59739.2,25.1871], Tmin=(100,'K'), Tmax=(856.594,'K')), NASAPolynomial(coeffs=[25.4665,-0.000962501,3.32531e-06,-8.33357e-10,6.32448e-14,-65153.3,-101.993], Tmin=(856.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-498.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + missing(O2d-Cdd) + group(Cd-Cd(CCO)H) + group(Cds-(Cdd-O2d)CsOs) + group(Cds-CdsCsCs) + missing(Cdd-CdO2d)"""),
)
...
"""),
    E0 = (-183.337,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,1855,455,950,2120,512.5,787.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.713286,'amu*angstrom^2'), symmetry=1, barrier=(16.3999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.712706,'amu*angstrom^2'), symmetry=1, barrier=(16.3865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.715545,'amu*angstrom^2'), symmetry=1, barrier=(16.4518,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.0647,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.744662,0.0644694,-7.90884e-05,4.60802e-08,-1.01059e-11,-21926.9,25.0138], Tmin=(100,'K'), Tmax=(1214.43,'K')), NASAPolynomial(coeffs=[17.3259,0.00539927,-6.24399e-07,-1.42393e-11,4.92229e-15,-25625.7,-56.8498], Tmin=(1214.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-183.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cds-(Cdd-O2d)CsOs) + group(Cds-OdCsH) + missing(Cdd-CdO2d) + radical(CCCJ=O)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.46545e+14,'s^-1'), n=0.20628, Ea=(3.93641,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-4R!H->C',), comment="""Estimated from node Root_N-4R!H->C in family Retroene."""),
)

reaction(
    label = 'reaction2',
    reactants = ['CO2(4)', 'CC(O)=C=O(1316)'],
    products = ['O=C=C(O)CC(=O)O(949)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(0.01228,'m^3/(mol*s)'), n=2.86279, Ea=(320.057,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), uncertainty=RateUncertainty(mu=5.3453611489250746e-05, var=2.530939774000289, Tref=1000.0, N=2, data_mean=0.0, correlation='Root_N-5CbCdCsHN->Cs_N-4CbCdCsHN->H_Ext-4CsN-R',), comment="""Estimated from node Root_N-5CbCdCsHN->Cs_N-4CbCdCsHN->H_Ext-4CsN-R in family 1,3_Insertion_CO2.
Multiplied by reaction path degeneracy 6.0"""),
)

reaction(
    label = 'reaction3',
    reactants = ['H2O(11)', 'O=C=CC(O)=C=O(1317)'],
    products = ['O=C=C(O)CC(=O)O(949)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2CO(27)', 'O=C=C(O)O(1297)'],
    products = ['O=C=C(O)CC(=O)O(949)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(314,'cm^3/(mol*s)'), n=3.04, Ea=(164.85,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [cco_2H;R_OR] for rate rule [cco_2H;R_OH]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: 1,3_Insertion_ROR"""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['OH(9)', 'O=[C]CC(O)=C=O(1323)'],
    products = ['O=C=C(O)CC(=O)O(949)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(5)', '[O]C(=O)CC(O)=C=O(1324)'],
    products = ['O=C=C(O)CC(=O)O(949)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[O]C#CO(1302)', '[CH2]C(=O)O(130)'],
    products = ['O=C=C(O)CC(=O)O(949)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O=[C]O(117)', 'C=C(O)[C]=O(1233)'],
    products = ['O=C=C(O)CC(=O)O(949)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(5)', 'O=C=C(O)[CH]C(=O)O(1325)'],
    products = ['O=C=C(O)CC(=O)O(949)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.46545e+14,'s^-1'), n=0.20628, Ea=(355.414,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(3000,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, data_mean=0.0, correlation='Root_N-4R!H->C',), comment="""Estimated from node Root_N-4R!H->C in family Retroene."""),
)

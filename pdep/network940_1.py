...
"""),
    E0 = (-328.069,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2782.5,750,1395,475,1775,1000,298.787],'cm^-1')),
        HinderedRotor(inertia=(0.117735,'amu*angstrom^2'), symmetry=1, barrier=(7.45652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309064,'amu*angstrom^2'), symmetry=1, barrier=(19.4952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117566,'amu*angstrom^2'), symmetry=1, barrier=(7.45794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11774,'amu*angstrom^2'), symmetry=1, barrier=(7.45215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.822975,'amu*angstrom^2'), symmetry=1, barrier=(52.1185,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1229,0.0686446,-6.7678e-05,3.99941e-08,-1.03497e-11,-39358.5,25.1028], Tmin=(100,'K'), Tmax=(901.417,'K')), NASAPolynomial(coeffs=[7.78796,0.0390689,-1.84629e-05,3.59607e-09,-2.55059e-13,-40560.1,-6.36054], Tmin=(901.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-328.069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
"""),
    E0 = (-220.05,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.147603,'amu*angstrom^2'), symmetry=1, barrier=(10.4949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147603,'amu*angstrom^2'), symmetry=1, barrier=(10.4949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147603,'amu*angstrom^2'), symmetry=1, barrier=(10.4949,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147603,'amu*angstrom^2'), symmetry=1, barrier=(10.4949,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67829,0.0492833,-3.78189e-05,1.5722e-08,-2.7332e-12,-26381,18.7785], Tmin=(100,'K'), Tmax=(1330.82,'K')), NASAPolynomial(coeffs=[9.85767,0.0246986,-1.01086e-05,1.8406e-09,-1.25489e-13,-28558,-23.0199], Tmin=(1330.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-220.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), label="""ipropylooh""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
"""),
    E0 = (-281.343,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2782.5,750,1395,475,1775,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.394231,'amu*angstrom^2'), symmetry=1, barrier=(9.06415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.39189,'amu*angstrom^2'), symmetry=1, barrier=(9.01032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.390508,'amu*angstrom^2'), symmetry=1, barrier=(8.97855,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.389844,'amu*angstrom^2'), symmetry=1, barrier=(8.96328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (90.0779,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14224,0.0720999,-0.000120043,1.1191e-07,-4.02117e-11,-33743.8,21.5567], Tmin=(100,'K'), Tmax=(851.73,'K')), NASAPolynomial(coeffs=[5.2592,0.0328804,-1.59533e-05,3.02547e-09,-2.06497e-13,-33723.8,6.58966], Tmin=(851.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), label="""OCHCH2CH2OOH""", comment="""Thermo library: DFT_QCI_thermo"""),
)

species(
    label = 'C=COC(C)OO(559)',
...
"""),
    E0 = (-314.233,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
...
"""),
    E0 = (-326.616,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,180],'cm^-1')),
        HinderedRotor(inertia=(0.958583,'amu*angstrom^2'), symmetry=1, barrier=(22.0397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.958597,'amu*angstrom^2'), symmetry=1, barrier=(22.04,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.958491,'amu*angstrom^2'), symmetry=1, barrier=(22.0376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.958344,'amu*angstrom^2'), symmetry=1, barrier=(22.0342,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.958323,'amu*angstrom^2'), symmetry=1, barrier=(22.0337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (104.105,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.185025,0.0681989,-3.002e-05,-2.36965e-08,1.77706e-11,-39131.1,27.6589], Tmin=(100,'K'), Tmax=(946.152,'K')), NASAPolynomial(coeffs=[22.4885,0.0125671,-3.11269e-06,5.29508e-10,-4.13521e-14,-45082,-87.8523], Tmin=(946.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-326.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['HCO(16)', '[CH2]C(C)OO(511)'],
    products = ['CC(CC=O)OO(520)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(25)', 'O=CCCOO(558)'],
    products = ['CC(CC=O)OO(520)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['HO2(12)', 'C[CH]CC=O(561)'],
    products = ['CC(CC=O)OO(520)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['H(5)', '[CH2]C(CC=O)OO(566)'],
    products = ['CC(CC=O)OO(520)'],

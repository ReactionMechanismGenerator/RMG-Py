...
A full list of the libraries `can be found on the RMG website: <https://rmg.mit.edu/database/kinetics/libraries/>`_. 
...
A full list of the kinetic families `can be found on the RMG website: <https://rmg.mit.edu/database/kinetics/families/>`_. .

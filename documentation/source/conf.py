...
# sphinx-quickstart on Fri May 15 20:30:50 2009.
#
...
project = u'RMG'
copyright = u'2009, Prof. William H. Green and the RMG Team'
...
#html_use_opensearch = ''
html_use_opensearch = 'http://greengroup.github.com/RMG-Py/'
...
def add_value(app, what, name, obj, options, lines):
	...
	"""
	# if what's not data, do nothing
	if what not in ['data']: return 
	# if it is data, add an evaluation of it ('foo = bar') to the end

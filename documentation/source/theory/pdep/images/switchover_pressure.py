...
Tlist = numpy.arange(300.0, 2201.0, 100.0, numpy.float128)

Plist = numpy.zeros((len(Tlist),5), numpy.float128)

#                          300   400   500   600   700   800   900  1000  1100  1200  1300  1400  1500  1600  1700  1800  1900  2000  2100  2200
# m = 27
Plist[:,0] = numpy.array([-1.1, -0.9, -0.6, -0.4, -0.2,  0.0,  0.2,  0.5,  0.8,  1.1,  1.4,  1.7,  1.9,  2.1,  2.3,  2.5,  2.7,  2.9,  3.0,  3.1], numpy.float128)
# m = 39
Plist[:,1] = numpy.array([-1.6, -1.4, -1.2, -1.0, -0.7, -0.4, -0.1,  0.2,  0.5,  0.8,  1.1,  1.4,  1.7,  1.9,  2.1,  2.3,  2.5,  2.7,  2.9,  3.0], numpy.float128)
# m = 60
Plist[:,2] = numpy.array([-2.2, -2.0, -1.8, -1.5, -1.2, -0.9, -0.6, -0.3,  0.1,  0.5,  0.8,  1.1,  1.4,  1.6,  1.9,  2.1,  2.3,  2.5,  2.7,  2.9], numpy.float128)
# m = 102
Plist[:,3] = numpy.array([-2.9, -2.7, -2.4, -2.1, -1.8, -1.4, -1.0, -0.6, -0.2,  0.2,  0.5,  0.8,  1.1,  1.4,  1.7,  2.0,  2.2,  2.4,  2.6,  2.8], numpy.float128)
# m = 1000
Plist[:,4] = numpy.array([-4.1, -3.8, -3.5, -3.1, -2.7, -2.2, -1.7, -1.2, -0.8, -0.4,  0.0,  0.4,  0.8,  1.1,  1.4,  1.7,  2.0,  2.2,  2.4,  2.6], numpy.float128)
...
Tlist2 = numpy.arange(300.0, 2201.0, 10.0, numpy.float128)
Plist2 = numpy.zeros((len(Tlist2),5), numpy.float128)
for i in range(5):
